...
import com.novapay.sdk.platform.NovaPayPlatformCredentials
...
class AuthInterceptor constructor(private val sharedPrefs: Preferences): Interceptor {
    ...
    private fun callApi(originalRequest: Request) : Response {
        ...
        val formBody: RequestBody = FormBody.Builder()
            .add("client_id", NovaPayPlatformCredentials.ClientID )
            .add("client_secret", NovaPayPlatformCredentials.ClientSecret)
            .add("grant_type",NovaPayPlatformCredentials.GrantType)
            .build()
        val request =  originalRequest.newBuilder()
            .url("http://${NovaPaySdkEnvironment.TST.baseUrl}/services/identity/token")
